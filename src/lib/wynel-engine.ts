...
export function createDefaultWynelState(): WynelState {
  const defaultSpells: WarlockSpell[] = [
    // Cantrips
    {
      ...
      description: 'A searing beam of scarlet chaos crackles toward a creature within range. Make a ranged spell attack. On hit, deals 1d10 + 3 force/chaos damage (enhanced by Agonizing Blast). At higher levels: 2 beams at 5th, 3 beams at 11th, 4 beams at 17th level.',
      damageDice: '1d10+3',
    },
    {
      id: 'minor-illusion',
      ...
      duration: '1 minute',
      description: 'Create a sound or an image of an object within range that lasts for the duration. Physical interaction reveals it as an illusion, or a creature can examine it with an Investigation check vs your spell save DC.',
    },
    {
      id: 'friends',
      name: 'Friends',
      ...
      castingTime: '1 Action',
      range: 'Self',
      components: 'S, M (makeup applied to face)',
    ...
    },
    {
      ...
      components: 'V, S',
      duration: 'Concentration, up to 1 minute',
      description: "You create a bonfire on ground that you can see within range filling a 5-foot cube. Any creature in the bonfire's space when cast must succeed on a DEX saving throw or take 1d8 fire damage. A creature must also make the save when entering the space for the first time on a turn or ending its turn there. Ignites flammable objects. (Level 5: 2d8, Level 11: 3d8, Level 17: 4d8).",
      damageDice: '1d8',
    },
    {
      id: 'prestidigitation',
    ...
    // --- 1st Level Spells ---
    {
      ...
      components: 'V, S',
      duration: 'Instantaneous',
      description: 'Triggered when you take damage from a creature you can see within 60 ft. Cast at 2nd level via Pact Magic: Attacker must make a DEX saving throw, taking 3d10 crimson flame damage on a failure (2d10 base + 1d10 for 2nd-level slot), or half on success.',
      damageDice: '3d10',
    },
    {
      ...
      duration: '1 hour',
      description: 'For the duration, you understand the literal meaning of any spoken language that you hear. You also understand any written language that you see by touching the surface (takes about 1 minute per page). Does not decode secret messages or non-language glyphs.',
    },
    {
      id: 'sense-emotion',
      name: 'Sense Emotion',
      ...
      components: 'V, S',
      duration: 'Concentration, up to 1 minute',
      description: 'You attune your senses to pick up the emotions of others. When you cast the spell, and as your action on each turn until the spell ends, you can focus on one humanoid within 30 feet to instantly learn their prevailing emotion (love, anger, pain, fear, calm, etc.). If the target is immune to charm or non-humanoid, you sense that it is calm.',
    },
    {
      id: 'dissonant-whispers',
      name: 'Dissonant Whispers (Scarlet Discord)',
      level: 1,
      school: 'Enchantment',
      castingTime: '1 Action',
      range: '60 feet',
      components: 'V',
      duration: 'Instantaneous',
      description: 'Great Old One Patron spell. Cast at 2nd level via Pact Magic: You whisper a discordant melody that wracks the target in psychic agony. Target must make a WIS saving throw. On a failure, it takes 4d6 psychic damage (3d6 base + 1d6 for 2nd-level slot) and must immediately use its reaction to move as far as its speed allows away from you. Half damage and no movement on success.',
      damageDice: '4d6',
    },
    {
      ...
      duration: 'Concentration, up to 1 minute',
      description: 'Great Old One Patron spell. A creature within range perceives everything as hilariously funny. Target must succeed on a WIS saving throw or fall prone, becoming incapacitated and unable to stand up for the duration. Target repeats the save at the end of each turn and each time it takes damage (with advantage). Creatures with INT 4 or lower are unaffected.',
    },
    {
      id: 'faerie-fire',
    ...
    {
      id: 'invisibility',
      name: 'Invisibility (Scarlet Veil)',
      level: 2,
      school: 'Illusion',
      castingTime: '1 Action',
      range: 'Touch',
      ...
      description: 'A creature you touch becomes invisible until the spell ends. Anything the target is wearing or carrying is invisible as long as it is on the person. Ends early if the target attacks or casts a spell.',
    },
    {
      id: 'detect-thoughts',
      name: 'Detect Thoughts (Mind Probe)',
      level: 2,
      school: 'Divination',
      castingTime: '1 Action',
      range: 'Self',
      ...
      duration: 'Concentration, up to 1 minute',
      description: 'Great Old One Patron spell. Read surface thoughts of creatures within 30 feet. As an action, probe deeper into a mind (WIS save to resist). Can also scan through barriers (penetrates 2 ft rock, 2 in metal) to detect thinking creatures.',
    },
    {
      id: 'phantasmal-force',
      ...
      duration: 'Concentration, up to 1 minute',
      description: 'Great Old One Patron spell. You craft an illusion that takes root in the mind of a creature within range (INT saving throw). The phantasm seems completely real to the target, dealing 1d6 psychic damage per turn if perceived as hazardous.',
      damageDice: '1d6',
    },
  ];
  ...
  const defaultFeatures: WarlockFeature[] = [
    ...
    {
      name: 'Awakened Mind (30 ft Telepathy)',
      source: 'Patron',
      description: 'Your otherworldly patron grants you the ability to telepathically speak to any creature you can see within 30 feet of you. You do not need to share a language with the creature, provided it understands at least one language.',
    },
    {
