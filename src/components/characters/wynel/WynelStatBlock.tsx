...
export default function WynelStatBlock({ wynel }: WynelStatBlockProps) {
  ...
  return (
    <div className="space-y-6 font-['Spectral',serif]">
      ...
      <SpotlightCard className="p-5 glass-card border-2 border-red-500/40 bg-[linear-gradient(135deg,rgba(35,10,18,0.96)_0%,rgba(16,4,8,0.98)_100%)] shadow-[0_12px_40px_rgba(239,68,68,0.2)] relative overflow-hidden rounded-2xl">
        <span className="medieval-corner tl text-red-400/50">❖</span>
        <span className="medieval-corner tr text-red-400/50">❖</span>
        <span className="medieval-corner bl text-red-400/50">❖</span>
        <span className="medieval-corner br text-red-400/50">❖</span>
        <div className="absolute inset-[5px] border border-red-500/20 rounded-xl pointer-events-none" />
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
            {abilities.map((ab) => (
              ...
              >
                ...
                {ab.isSaveProf && (
                  <div className="absolute -top-1 -right-1 w-4 h-4 bg-red-600 border border-red-400 rounded-full flex items-center justify-center shadow-md" title="Save Proficiency">
      ...
      <SpotlightCard className="p-5 glass-card border-2 border-red-500/40 bg-[linear-gradient(135deg,rgba(35,10,18,0.96)_0%,rgba(16,4,8,0.98)_100%)] shadow-[0_12px_40px_rgba(239,68,68,0.15)] relative overflow-hidden rounded-2xl">
        <span className="medieval-corner tl text-red-400/50">❖</span>
        <span className="medieval-corner tr text-red-400/50">❖</span>
        <span className="medieval-corner bl text-red-400/50">❖</span>
        <span className="medieval-corner br text-red-400/50">❖</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Skills Column */}
        <SpotlightCard className="p-5 glass-card border-2 border-red-500/40 bg-[linear-gradient(135deg,rgba(35,10,18,0.96)_0%,rgba(16,4,8,0.98)_100%)] shadow-xl relative overflow-hidden rounded-2xl">
          <span className="medieval-corner tl text-red-400/50">❖</span>
          <span className="medieval-corner tr text-red-400/50">❖</span>
          <span className="medieval-corner bl text-red-400/50">❖</span>
          <span className="medieval-corner br text-red-400/50">❖</span>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-serif text-xs">{sk.name}</span>
        ...
        <SpotlightCard className="p-5 glass-card border-2 border-red-500/40 bg-[linear-gradient(135deg,rgba(35,10,18,0.96)_0%,rgba(16,4,8,0.98)_100%)] shadow-xl space-y-4 relative overflow-hidden rounded-2xl">
          <span className="medieval-corner tl text-red-400/50">❖</span>
          <span className="medieval-corner tr text-red-400/50">❖</span>
          <span className="medieval-corner bl text-red-400/50">❖</span>
          <span className="medieval-corner br text-red-400/50">❖</span>
